...
function buildDesiredMembers(
  ...
  // -wall-direction (see member-orientation.ts). For the END chord that
  // already faces inward (toward the wall body), so orientation_deg = 0.
  // For the START chord the body is the other way, so we rotate the
  // cross-section 180° about the member axis to face the flanges inward.
